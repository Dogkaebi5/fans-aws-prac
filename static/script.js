  ...
  fetch("/homework")
    ...
    .then((data) => {
      ...
      for (let i = 0; i < max_page; i++) {
        ...
        temp_page.innerHTML = `<li class="page-item"><a class="page-link" id="${page_num}" onclick="show_comment(this.id)">${page_num}</a></li>`;
